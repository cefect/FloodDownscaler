...
slice a set of layers and report on feature counts
    seems a bit too sophisticated to go in coms
'''
#===============================================================================
# script paths
#===============================================================================
work_dir = r'C:\LS\03_TOOLS\misc'
out_dir = r'C:\LS\03_TOOLS\misc\outs'
...
class Sliceor(Qproj):
    ...
    def load_layers_dir(self,
        ...
        for dirpath, dirnames, fns_raw in os.walk(data_dir):
            ...
            log.debug('%s    %s    %s' % (dirpath, dirnames, fns_raw))
            ...
            for fileName in filenames:
                ...
                layer = self.vlay_load(fp , logger=log, **vlay_load)
